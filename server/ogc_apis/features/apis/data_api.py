...
async def get_feature(
    ...
    featureId: Annotated[StrictStr, Field(description="local identifier of a feature")] = Path(..., description="local identifier of a feature"),
) -> FeatureGeoJSON:
