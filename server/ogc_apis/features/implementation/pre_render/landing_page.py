...
def generate_landing_page(base_url: str, root_path: str) -> LandingPage:   
    ...
    known_links = [
        ...
        Link(href=f"{features_base_route}{FEATURES_API_ROUTE}.json", rel="service-desc", type="application/vnd.oai.openapi+json;version=3.0", title="the API definition"),
        Link(href=f"{features_base_route}{FEATURES_API_ROUTE}.html", rel="service-doc", type="text/html", title="the API documentation"),
