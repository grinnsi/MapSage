...
class GeometrycollectionGeoJSON(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('GeometryCollection',):
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "geometries": [GeometryGeoJSON.from_dict(_item) for _item in obj.get("geometries")] if obj.get("geometries") is not None else None
        })
        return _obj
